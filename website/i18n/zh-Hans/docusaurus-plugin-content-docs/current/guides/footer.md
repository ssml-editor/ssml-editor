...
底部栏可以额外的配置与编辑器操作相关的功能元素。例如：[提交按钮](https://github.com/ssml-editor/ssml-editor/blob/master/packages/editor-vue/src/common/footer-menu/submit/submit-menu.vue) 。
...
通过 [配置](https://github.com/ssml-editor/ssml-editor/blob/master/example/src/config.ts) 对象的 `footer` 属性传入元素：
